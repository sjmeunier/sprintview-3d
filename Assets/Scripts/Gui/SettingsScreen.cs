...
namespace Assets.Scripts.Gui
{
	public class SettingsScreen
	{
		...
		public void draw()
		{
			...
			GUILayout.BeginHorizontal();
			GUILayout.Label("A frivolous and overengineered sprint burndown tool written by Serge Meunier");
			GUILayout.EndHorizontal();
			...
			GUILayout.EndHorizontal();
			GUILayout.BeginHorizontal();
			Settings.IsSoundOn = GUILayout.Toggle(Settings.IsSoundOn, "Sound enabled");
			GUILayout.EndHorizontal();
			GUILayout.EndVertical();
			GUILayout.EndHorizontal();
			GUILayout.BeginHorizontal();
